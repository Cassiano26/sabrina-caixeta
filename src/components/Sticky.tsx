    ...
    <section className="relative w-full bg-[#FAEFE6] px-4 py-16 text-[#313131] lg:px-26">
      ...
      <div className="relative z-10 mx-auto flex w-full flex-col gap-8 text-center lg:w-2/3">
        ...
        <p className="text-[16px] leading-tight lg:text-[20px]">
          ...
          , de forma dinâmica e presente, para que possamos construir juntas uma
          jornada que integre seu corpo ao seu momento.
        </p>
      </div>
          ...
          {items.map((item, index) => (
            <div key={index} className="flex w-4/5 gap-4">
              ...
              <div>
                ...
                <p className="text-[16px] leading-tight">{item.description}</p>
              </div>
            </div>
          ))}
        </div>
